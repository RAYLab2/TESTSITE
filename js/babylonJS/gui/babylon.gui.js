            ...
            AdvancedDynamicTexture.prototype._checkUpdate = function (camera) {
                ...
                if (this._isFullscreen && this._linkedControls.length) {
                    ...
                    for (var _i = 0, _a = this._linkedControls; _i < _a.length; _i++) {
                        ...
                        var position = mesh.getBoundingInfo().boundingBox.center; // by Mac
                        // position.y = mesh.getBoundingInfo().boundingBox.maximum.y;
...
(function (BABYLON) {
    ...
    (function (GUI) {
	    ...
	    // by Mac
	     Object.defineProperty(Control.prototype, "letterSpacing", {
                get: function () {
    ...
    (function (GUI) {
        ...
        var Container = /** @class */ (function (_super) {
            ...
            Container.prototype._reOrderControl = function (control) {
                let _linkMesh = control._linkedMesh; //by Mac for link Mesh
                this.removeControl(control);
                control.linkWithMesh(_linkMesh); //by Mac for link Mesh
                control._onlyMeasureMode = false; //by Mac for link Mesh
...
(function (BABYLON) {
    var GUI;
    (function (GUI) {
        var TipRectangle = /** @class */ (function (_super) {
            __extends(TipRectangle, _super);
            function TipRectangle(name) {
                var _this = _super.call(this, name) || this;
                _this.name = name;
                _this._thickness = 1;
                _this._cornerRadius = 0;
                _this._arrawMeasure = null;// GUI.Measure.Empty();

                return _this;
            }
            Object.defineProperty(TipRectangle.prototype, "thickness", {
                get: function () {
                    return this._thickness;
                },
                set: function (value) {
            ...
            Object.defineProperty(TipRectangle.prototype, "cornerRadius", {
                get: function () {
                    return this._cornerRadius;
                },
                set: function (value) {
            ...
            Object.defineProperty(TipRectangle.prototype, "arrawMeasure", {
                get: function () {
                    return this._arrawMeasure;
                },
                set: function (value) {
                    ...
                    this._arrawMeasure = value;

                    if(value.alignment !== this._arrawMeasure.alignment || value.width !== this._arrawMeasure.width || value.height !== this._arrawMeasure.height )
                        this._markAsDirty();
                },
                enumerable: true,
                configurable: true
            });
            TipRectangle.prototype._getTypeName = function () {
                return "TipRectangle";
            };
            TipRectangle.prototype._localDraw = function (context) {
                context.save();
                if (this.shadowBlur || this.shadowOffsetX || this.shadowOffsetY) {
                    context.shadowColor = this.shadowColor;
                    context.shadowBlur = this.shadowBlur;
                ...
                if (this._background) {
                    ...
                    if (this._cornerRadius) {
                        ...
                        // context.lineTo(this._currentMeasure.left + this._currentMeasure.width, this._currentMeasure.top);
                        // context.lineTo(this._currentMeasure.left + this._currentMeasure.width, this._currentMeasure.top + this._currentMeasure.height);
                        // context.lineTo(this._currentMeasure.left, this._currentMeasure.top+ this._currentMeasure.height);

                        if (this._arrawMeasure === null || this._arrawMeasure === undefined)
                            return;

                        context.beginPath();

                        if(this._arrawMeasure.alignment === GUI.Control.HORIZONTAL_ALIGNMENT_RIGHT)
                        {
                            context.fillRect(this._currentMeasure.left, this._currentMeasure.top, this._currentMeasure.width - this._arrawMeasure.width, this._currentMeasure.height);

                            context.moveTo(this._currentMeasure.left + this._currentMeasure.width - this._arrawMeasure.width, this._currentMeasure.top + this._arrawMeasure.y);
                            context.lineTo(this._currentMeasure.left + this._currentMeasure.width, this._currentMeasure.top + this._arrawMeasure.y + this._arrawMeasure.height * 0.5);
                            context.lineTo(this._currentMeasure.left + this._currentMeasure.width - this._arrawMeasure.width, this._currentMeasure.top + this._arrawMeasure.y + this._arrawMeasure.height);
                        }
                        else if(this._arrawMeasure.alignment === GUI.Control.HORIZONTAL_ALIGNMENT_LEFT)
                        {
                            context.fillRect(this._currentMeasure.left + this._arrawMeasure.width, this._currentMeasure.top, this._currentMeasure.width, this._currentMeasure.height);
                            context.moveTo(this._currentMeasure.left + this._arrawMeasure.width, this._currentMeasure.top + this._arrawMeasure.y);
                            context.lineTo(this._currentMeasure.left, this._currentMeasure.top + this._arrawMeasure.y + this._arrawMeasure.height * 0.5);
                            context.lineTo(this._currentMeasure.left + this._arrawMeasure.width, this._currentMeasure.top + this._arrawMeasure.y + this._arrawMeasure.height);
                        }
            ...
            TipRectangle.prototype._additionalProcessing = function (parentMeasure, context) {
                _super.prototype._additionalProcessing.call(this, parentMeasure, context);
                this._measureForChildren.width -= 2 * this._thickness;
                this._measureForChildren.height -= 2 * this._thickness;
                this._measureForChildren.left += this._thickness;
            ...
            TipRectangle.prototype._drawRoundedRect = function (context, offset) {
                if (offset === void 0) { offset = 0; }
                var x = this._currentMeasure.left + offset;
                var y = this._currentMeasure.top + offset;
                var width = this._currentMeasure.width - offset * 2;
            ...
            TipRectangle.prototype._clipForChildren = function (context) {
                if (this._cornerRadius) {
                    this._drawRoundedRect(context, this._thickness);
                    context.clip();
                }
    ...
    (function (GUI) {
        ...
        var Line = /** @class */ (function (_super) {
            ...
            function Line(name) {
                ...
                _this._x2Offset = 0;// by Mac
                _this._y2Offset = 0;// by Mac
            ...
            Object.defineProperty(Line.prototype, "_effectiveX2", {
                get: function () {
                    return (this._connectedControl ? this._connectedControl.centerX + this._x2Offset : 0) + this._x2.getValue(this._host); // by Mac
                },
                enumerable: true,
                configurable: true
            });
            Object.defineProperty(Line.prototype, "_effectiveY2", {
                get: function () {
                    return (this._connectedControl ? this._connectedControl.centerY + this._y2Offset  : 0) + this._y2.getValue(this._host); // by Mac
                },
                enumerable: true,
                configurable: true
            });
            Object.defineProperty(Line.prototype, "x2Offset", { // by Mac
                /** Gets or sets the control position  in world space */
                get: function () {
                    return this._x2Offset;
                },
                set: function (value) {
                    this._x2Offset = value;
                },
            });
            Object.defineProperty(Line.prototype, "y2Offset", { // by Mac
                /** Gets or sets the control position  in world space */
                get: function () {
                    return this._y2Offset;
                },
                set: function (value) {
                    this._y2Offset = value;
                },
            });
...
(function (BABYLON) {
    ...
    (function (GUI) {
        var DrawLine = /** @class */ (function (_super) {
            ...
            Object.defineProperty(DrawLine.prototype, "dash", {
                get: function () {
                    return this._dash;
                },
                set: function (value) {
            ...
            Object.defineProperty(DrawLine.prototype, "push", {
                set: function (value) {
            ...
            Object.defineProperty(DrawLine.prototype, "points", {
                get: function () {
                    return this._points;
                },
                set: function (value) {
                    ...
                    let bDraw = false;
                    bDraw = this._points.length !== value;
                    if(bDraw)
                    {
                        for(let i = 0; i < this._points.length; ++i)
                        {
                            if(this._points[i].equals(value[i] === false))
                            {
                                bDraw = true;
                                break;
                            }
            ...
            Object.defineProperty(DrawLine.prototype, "lineWidth", {
                get: function () {
                    return this._lineWidth;
                },
                set: function (value) {
            ...
            DrawLine.prototype._getTypeName = function () {
                return "DrawLine";
            };
            DrawLine.prototype._draw = function (parentMeasure, context) {
                context.save();
                if (this.shadowBlur || this.shadowOffsetX || this.shadowOffsetY) {
                    context.shadowColor = this.shadowColor;
                    context.shadowBlur = this.shadowBlur;
                ...
                if (this._processMeasures(parentMeasure, context)) {
                    ...
                    let _x1 = new GUI.ValueAndUnit(0);
                    let _y1 = new GUI.ValueAndUnit(0);

                    _x1.fromString(this._points[0].x + this._currentMeasure.left);
                    _y1.fromString((this._currentMeasure.height -this._points[0].y) + this._currentMeasure.top);

                    context.moveTo(_x1.getValue(this._host), _y1.getValue(this._host));
                    for(let i = 1; i < this._points.length; ++i)
                    {
                        _x1.fromString(this._points[i].x + this._currentMeasure.left);
                        _y1.fromString((this._currentMeasure.height - this._points[i].y) + this._currentMeasure.top);
                        context.lineTo(_x1.getValue(this._host), _y1.getValue(this._host));
                    }
                    context.stroke();
                    context.restore();
                    ...
                    for(let i = 0; i < this._points.length; ++i)
                    {
                        ...
                        _y1.fromString((this._currentMeasure.height - this._points[i].y) + this._currentMeasure.top);
                        context.moveTo(_x1.getValue(this._host), _y1.getValue(this._host));
                        context.arc(_x1.getValue(this._host), _y1.getValue(this._host), this._lineWidth, 0, Math.PI * 2, true);
                    }
                    context.fill();
                    context.restore();
                }
            ...
            DrawLine.prototype._measure = function () {
                // Width / Height
                let _x1 = new GUI.ValueAndUnit(0);
                let _y1 = new GUI.ValueAndUnit(0);
                let _x2 = new GUI.ValueAndUnit(0);
                let _y2 = new GUI.ValueAndUnit(0);

                if(this._points.length > 2)
                {
                    let x1 = this._points[0].x;
                    let x2 = this._points[0].x;
                    let y1 = this._points[0].y;
                    let y2 = this._points[0].y;

                    for(let i = 0; i < this._points.length; ++i )
                    {
                        if(x1 > this._points[i].x )
                            x1 = this._points[i].x;

                        if(x2 < this._points[i].x )
                            x2 = this._points[i].x;

                        if(y1 > this._points[i].y )
                            y1 = this._points[i].y;

                        if(y2 < this._points[i].y )
                            y2 = this._points[i].y;
                    }
                ...
                this._currentMeasure.width = Math.abs(_x1.getValue(this._host) - _x2.getValue(this._host));
                this._currentMeasure.height = Math.abs(_y1.getValue(this._host) - _y2.getValue(this._host));
            };
            return DrawLine;
        }(GUI.Control));
...
(function (BABYLON) {
    ...
    (function (GUI) {
        var SimpleSlider = /** @class */ (function (_super) {
            ...
            Object.defineProperty(SimpleSlider.prototype, "borderColor", {
                get: function () {
                    return this._borderColor;
                },
                set: function (value) {
            ...
            Object.defineProperty(SimpleSlider.prototype, "background", {
                get: function () {
                    return this._background;
                },
                set: function (value) {
            ...
            Object.defineProperty(SimpleSlider.prototype, "minimum", {
                get: function () {
                    return this._minimum;
                },
                set: function (value) {
            ...
            Object.defineProperty(SimpleSlider.prototype, "maximum", {
                get: function () {
                    return this._maximum;
                },
                set: function (value) {
            ...
            Object.defineProperty(SimpleSlider.prototype, "value", {
                get: function () {
                    return this._value;
                },
                set: function (value) {
            ...
            SimpleSlider.prototype._getTypeName = function () {
                return "SimpleSlider";
            };
            SimpleSlider.prototype._draw = function (parentMeasure, context) {
                context.save();
                this._applyStates(context);
                if (this._processMeasures(parentMeasure, context)) {
                    ...
                    context.fillStyle = this._background;
                    context.fillRect(left, this._currentMeasure.top, width, this._currentMeasure.height);
                    if (this.shadowBlur || this.shadowOffsetX || this.shadowOffsetY) {
                        context.shadowBlur = 0;
                        context.shadowOffsetX = 0;
                        context.shadowOffsetY = 0;
                    ...
                    context.fillStyle = this.color;
                    context.fillRect(left, this._currentMeasure.top, thumbPosition, this._currentMeasure.height);
            ...
            SimpleSlider.prototype.EventLock = function (enable) {

                this.isHitTestVisible = enable;
            };
            SimpleSlider.prototype._updateValueFromPointer = function (x, y) {
                if (this.rotation != 0) {
                    this._invertTransformMatrix.transformCoordinates(x, y, this._transformedPosition);
                    x = this._transformedPosition.x;
                }
            ...
            SimpleSlider.prototype._onPointerDown = function (target, coordinates, pointerId, buttonIndex) {
                if (!_super.prototype._onPointerDown.call(this, target, coordinates, pointerId, buttonIndex)) {
                    return false;
                }
                this._pointerIsDown = true;
            ...
            SimpleSlider.prototype._onPointerMove = function (target, coordinates) {
                if (this._pointerIsDown) {
                    this._updateValueFromPointer(coordinates.x, coordinates.y);
                }
                _super.prototype._onPointerMove.call(this, target, coordinates);
            };
            SimpleSlider.prototype._onPointerUp = function (target, coordinates, pointerId, buttonIndex, notifyClick) {
                this._pointerIsDown = false;
                delete this._host._capturingControl[pointerId];
                _super.prototype._onPointerUp.call(this, target, coordinates, pointerId, buttonIndex, notifyClick);
            };
...
(function (BABYLON) {
    ...
    (function (GUI) {
	    ...
	    //by Mac
            TextBlock.prototype.fillTextWithSpacing = function(context, text, x, y, spacing)
            {
		...
		// by Mac
                this.fillTextWithSpacing(context, text, this._currentMeasure.left + x, y, this.letterSpacing);
	    ...
	    //by Mac
            TextBlock.prototype._parseLineWithTextLetterSpacing = function (text, context) {
                ...
                if(this._letterSpacing != 0)
                {
                    ...
                    do
                    {
                        ...
                        let wChar = metrics.width - wShorter;
                        width += wChar + this._letterSpacing;
                        metrics.width = wShorter;
                    } while (text != "");
		    ...
		    //by Mac
                    ...
                    // letterSpacing
                    let metrics = this._parseLineWithTextLetterSpacing(testLine,context);
                    var testWidth = metrics.width;
                    if (testWidth > width && n > 0) {
                        this._lines.push({ text: line, width: lineWidth });
                        line = words[n];
                        //lineWidth = context.measureText(line).width;
                        lineWidth = this._parseLineWithTextLetterSpacing(line,context).width;
                    }
                    else {
                        lineWidth = testWidth;
                        line = testLine;
...
(function (BABYLON) {
    ...
    (function (GUI) {
        var RichTextBlock = /** @class */ (function (_super) {
            ...
            /**
             * Creates a new RichTextBlock object
             * @param name defines the name of the control
             * @param text defines the text to display (emptry string by default)
             */
            ...
            Object.defineProperty(RichTextBlock.prototype, "textColors", {
                /**
                 * Gets or sets text to display
                 */
                get: function () {
                ...
                set: function (value) {
                    ...
                    if (this._textColors.length === value.length)
                    {
                        let bSame = true;

                        for(let i =0; i < this._textColors.length; ++i)
                        {
                            if (this._textColors[i] !== value[i])
                            {
                                bSame = false;
                                break;
                            }
            ...
            Object.defineProperty(RichTextBlock.prototype, "textList", {
                /**
                 * Gets or sets text to display
                 */
                get: function () {
                ...
                set: function (value) {
                    ...
                    if (this._textList.length === value.length)
                    {
                        let bSame = true;
                        for(let i =0; i < this._textList.length; ++i)
                        {
                            if (this._textList[i] !== value[i])
                            {
                                bSame = false;
                                break;
                            }
            ...
            Object.defineProperty(RichTextBlock.prototype, "lines", {
                /**
                 * Return the line list (you may need to use the onLinesReadyObservable to make sure the list is ready)
                 */
                get: function () {
            ...
            Object.defineProperty(RichTextBlock.prototype, "resizeToFit", {
                /**
                 * Gets or sets an boolean indicating that the TextBlock will be resized to fit container
                 */
                get: function () {
            ...
            Object.defineProperty(RichTextBlock.prototype, "textWrapping", {
                /**
                 * Gets or sets a boolean indicating if text must be wrapped
                 */
                get: function () {
            ...
            Object.defineProperty(RichTextBlock.prototype, "text", {
                /**
                 * Gets or sets text to display
                 */
                get: function () {
            ...
            Object.defineProperty(RichTextBlock.prototype, "textHorizontalAlignment", {
                /**
                 * Gets or sets text horizontal alignment (BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER by default)
                 */
                get: function () {
            ...
            Object.defineProperty(RichTextBlock.prototype, "textVerticalAlignment", {
                /**
                 * Gets or sets text vertical alignment (BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER by default)
                 */
                get: function () {
            ...
            Object.defineProperty(RichTextBlock.prototype, "lineSpacing", {
                /**
                 * Gets or sets line spacing value
                 */
                get: function () {
            ...
            Object.defineProperty(RichTextBlock.prototype, "outlineWidth", {
                /**
                 * Gets or sets outlineWidth of the text to display
                 */
                get: function () {
            ...
            Object.defineProperty(RichTextBlock.prototype, "outlineColor", {
                /**
                 * Gets or sets outlineColor of the text to display
                 */
                get: function () {
            ...
            RichTextBlock.prototype._getTypeName = function () {
                return "RichTextBlock";
            };
            RichTextBlock.prototype.fillTextWithSpacing = function(context, text, x, y, spacing)
            {
                let index = 0;
                let bChange = true;
                let wAll = context.measureText(text).width;
                ...
                do
                {
                    if(this._textList.length > 0 && index < this._textList.length && bChange)
                    {
                        if(this._textColors.length > index)
                            context.fillStyle = this._textColors[index];
            ...
            RichTextBlock.prototype._drawText = function (text, textWidth, y,context) {
                var width = this._currentMeasure.width;
                var x = 0;
                switch (this._textHorizontalAlignment) {
                    case GUI.Control.HORIZONTAL_ALIGNMENT_LEFT:
            ...
            /** @hidden */
            RichTextBlock.prototype._draw = function (parentMeasure, context) {
                context.save();
                this._applyStates(context);
                if (this._processMeasures(parentMeasure, context)) {
                    // Render lines
            ...
            RichTextBlock.prototype._applyStates = function (context) {
                _super.prototype._applyStates.call(this, context);
                if (this.outlineWidth) {
                    context.lineWidth = this.outlineWidth;
                    context.strokeStyle = this.outlineColor;
            ...
            RichTextBlock.prototype._additionalProcessing = function (parentMeasure, context) {
                this._lines = [];
                var _lines = this.text.split("\n");
                if (this._textWrapping && !this._resizeToFit) {
                    for (var _i = 0, _lines_1 = _lines; _i < _lines_1.length; _i++) {
            ...
            RichTextBlock.prototype._parseLine = function (line, context) {
                if (line === void 0) { line = ''; }
                return { text: line, width: context.measureText(line).width };
            };
            RichTextBlock.prototype._parseLineWithTextLetterSpacing = function (text, context) {
                let metrics = context.measureText(text);
                if(this._letterSpacing != 0)
                {
                    let width = 0;
            ...
            RichTextBlock.prototype._parseLineWithTextWrapping = function (line, context) {
                if (line === void 0) { line = ''; }
                var words = line.split(' ');
                var width = this._currentMeasure.width;
                var lineWidth = 0;
            ...
            RichTextBlock.prototype._renderLines = function (context) {
                var height = this._currentMeasure.height;
                if (!this._fontOffset) {
                    this._fontOffset = GUI.Control._GetFontOffset(context.font);
                }
            ...
            RichTextBlock.prototype.dispose = function () {
                _super.prototype.dispose.call(this);
                this.onTextChangedObservable.clear();
            };
            return RichTextBlock;
        }(GUI.Control));
        GUI.RichTextBlock = RichTextBlock;
    })(GUI = BABYLON.GUI || (BABYLON.GUI = {}));
})(BABYLON || (BABYLON = {}));
    ...
    (function (GUI) {
        ...
        var Image = /** @class */ (function (_super) {
            ...
            function Image(name, url) {
                ...
                _this._cellId = -1;
                _this.source = url;
                _this.onLoadedObservable = new BABYLON.Observable(); // by Mac
            ...
            Image.prototype._onImageLoaded = function () {
                ...
                this.onLoadedObservable.notifyObservers();//by Mac
                this._markAsDirty();
            };
